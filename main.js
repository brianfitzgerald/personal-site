...
var author$project$View$Components$itemRow = F2(
	function (t, content) {
		return A2(
...
var author$project$View$Components$linkButton = F2(
	function (t, link) {
		return A2(
			rtfeldman$elm_css$Html$Styled$span,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							...
							rtfeldman$elm_css$Css$hex('009AFF')),
...
var author$project$View$Components$project = function (proj) {
	return A2(
		rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$text(proj.title)
							])),
						A2(
						elm$core$Maybe$withDefault,
						...
						A2(
							elm$core$Maybe$map,
							author$project$View$Components$linkButton('Open'),
							proj.link))
					])),
				A2(
				rtfeldman$elm_css$Html$Styled$span,
				...
				_List_fromArray(
					[
						rtfeldman$elm_css$Html$Styled$text(proj.tagline)
					])),
				A2(
				rtfeldman$elm_css$Html$Styled$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						rtfeldman$elm_css$Html$Styled$text(proj.description)
					])),
				A2(
				rtfeldman$elm_css$Html$Styled$span,
				_List_Nil,
...
var author$project$View$Components$title = function (content) {
	return A2(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						rtfeldman$elm_css$Html$Styled$text('This site was built with '),
						A2(
						rtfeldman$elm_css$Html$Styled$a,
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$Attributes$href('http://elm-lang.org/'),
								rtfeldman$elm_css$Html$Styled$Attributes$css(
								_List_fromArray(
									[
										rtfeldman$elm_css$Css$textDecoration(rtfeldman$elm_css$Css$none)
						...
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$text('Elm.')
							]))
					]))
			]));
};
...
var author$project$Main$main = elm$browser$Browser$sandbox(
	{
		...
		view: A2(elm$core$Basics$composeR, author$project$View$App$view, rtfeldman$elm_css$Html$Styled$toUnstyled)
	});
